...
!function ($j) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatLoadingMessage: function () {
            return 'Cargando, por favor espere... <br><br><br><img src="../includes/imagens/loading.gif">';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s Archivos por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Demostración %s la %s de %s archivos', pageFrom, pageTo, totalRows);
        },
