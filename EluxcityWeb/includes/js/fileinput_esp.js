...
(function (factory) {
    ...
    STYLE_SETTING = 'style="width:580px;height:{height};"';
    ...
    tBtnLink = '<button type="{type}" tabindex="500"  onclick="javascript: uploadArquivo()" title="{title}" class="{css}" {status}>{icon}{label}</button>';
    ...
    tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" onclick="uploadArquivo()" title="{uploadTitle}">' +
        '   {uploadIcon}\n</button>\n';
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'arquivo',
        filePlural: 'arquivos',
        browseLabel: 'Busqueda&hellip;',
        removeLabel: 'Eliminar',
        removeTitle: 'Eliminar los archivos seleccionados',
        cancelLabel: 'Cancelar',
        cancelTitle: 'Detener el envío en curso',
        uploadLabel: 'Enviar',
        uploadTitle: 'Enviar archivos seleccionados',
        msgNo: 'Não',
        msgCancelled: 'Cancelado',
        msgZoomTitle: 'Ver detalhes',
        msgZoomModalHeading: 'Detalhes',
        ...
        dropZoneTitle: 'Arrastrar y soltar el archivo aqui',
        fileActionSettings: {
            removeTitle: 'Eliminar el archivo',
            uploadTitle: 'carga de archivos',
            indicatorNewTitle: 'Todavía no se ha subido',
