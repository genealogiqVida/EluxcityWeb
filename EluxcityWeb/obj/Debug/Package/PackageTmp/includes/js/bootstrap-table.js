...
!function ($j) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatLoadingMessage: function () {
            return 'Carregando, por favor aguarde... <br><br><br><img src="../includes/images/loading.gif">';
        },
    ...
    BootstrapTable.prototype.onPageFirst = function (event) {
        ...
        if (telaAtual == 'conteudo') {
            ...
            var temas = $("#tema").select2('val');
            if (temas == 'null') temas = "";
            if (temas == null) temas = "";
            carregaDadosTabela(titulo, temas, proprietario, status, tipo);
        }
