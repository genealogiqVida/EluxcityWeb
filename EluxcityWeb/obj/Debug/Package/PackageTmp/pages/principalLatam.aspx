<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="principalLatam.aspx.cs" Inherits="EluxcityWeb.pages.principalLatam" %>
               ...
               <div class="card" style="min-width: 1202px !important;">
                      <div class="card-body">
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>')">
                                              <label style="cursor: pointer"><b>Manual de servicio</b></label></button></td>
                                      <td>
                                          <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>&idioma=<%=idioma %>')">
                                              <label style="cursor: pointer"><b>Boletines tecnicos</b></label></button></td>
                                      <td>
                          ...
                          <% if(!myStringBuilderLancamento.ToString().Equals("")) { %>
                           <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Lanzamientos</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                          ...
                          <div class="row">
                                 <div class="col" style="text-align: center;">
                                           <label class="lblCarrossel" style="font-size: 16px; color: red; text-align: center;"><b>No hay contenidos/cursos para mostrar aquí</b></label>
                                </div>
                          </div> 
                          ...
                          <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Entrenamientos para ti</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                           ...
                           <% } %>
                            ...
                            <% if (!myStringBuilderSegunda.ToString().Equals(""))
                              { %> 
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Últimos manuales técnicos</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                          ...
                          <% if (!myStringBuilderPrimeira.ToString().Equals(""))
                              { %> 
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Últimos boletines técnicos</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
