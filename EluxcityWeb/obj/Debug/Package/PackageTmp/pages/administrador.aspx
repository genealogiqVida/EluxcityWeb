...
<html style="background-color:#e6e6e6">
    ...
    <div class="col-md align-self-center">        <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Manual de serviços</b></label></button>
</div>
    <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button>
</div>

      <div class="col-md-1 align-self-center"> <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button>
 </div>
  </div>
...
<div class="row" style="width: 90%; text-align: center;">
    ...
    <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button>
      ...
      <div class="col-md align-self-center"> <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button>
 </div>
  </div>
              ...
              <div class="col" style="width: 1200px; height:249px; background: url('../includes/images/rodape.png');"> 
                   ...
                   <span style="position: relative; top: 121px; left: 87px; color: #ACC4DF;  font-size: 14px;  font-weight: 400;">Peças e acessórios</span>
                         ...
                         <span style="position: relative; top: 30px; left: 223px; color: #ACC4DF;  font-size: 14px;  font-weight: 400;">Política de Privacidade</span>
                            ...
                            <span style="position: relative; top: 61px; left: -20px; color: #ACC4DF;  font-size: 14px;  font-weight: 400; cursor:pointer;" onclick="carregaTela('contactcenter.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>')">Contact Center</span>
