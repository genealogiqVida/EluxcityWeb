<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="videos.aspx.cs" Inherits="EluxcityWeb.pages.videos" %>
...
<% if(equipe.ToString().Equals("S")) { %>    
                               ...
                               <div class="row" style="width: 100%; text-align: center;">
                                    <div class="col-md align-self-center">        <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('index.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>')"><label style="cursor: pointer"><b>Home</b></label></button>
</div>
    <div class="col-md-2 align-self-center">        <button type="button" class="btn btn-warning" style="cursor: pointer"><label style="cursor: pointer"><b>Service Plus</b></label></button>
</div>
       

    <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('https://eluxcitysb-teste.sabacloud.com/Saba/Web_spf/NA1TNB0106/app/team/overview')"><label style="cursor: pointer"><b>Gestão da equipe</b></label></button>
</div>



    <div class="col-md align-self-center">        <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>')"><label style="cursor: pointer"><b>Manual de serviços</b></label></button>
</div>
    <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button>
</div>

      <div class="col-md-1 align-self-center"> <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button>
 </div>
  </div>
...
<div class="row" style="width: 90%; text-align: center;">
    ...
    <div class="col-md align-self-center">        <button type="button" class="btn btn-warning" style="cursor: pointer"><label style="cursor: pointer"><b>Service Plus</b></label></button>
</div>
    ...
    <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button>
      ...
      <div class="col-md align-self-center"> <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button>
 </div>
  </div>
             ...
             <%  } else { %>
                           ...
                           <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de geladeiras</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                          ...
                          <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de Ar condicionado</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                          ...
                          <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de secadoras</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                          ...
                          <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de fogões</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                             ...
                             <%  }  %>
                              ...
                              <%   if (!myStringBuilderRecente.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de máquinas de lavar</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                             ...
                             <%  }  %>
                              ...
                              <%   if (!myStringBuilderPopular.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de condicionadores de Ar</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                           ...
                           <%  }  %>
                              ...
                              <%   if (!myStringBuilderPrimeira.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de eletroportáteis</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                            ...
                            <%  }  %>
                              ...
                              <%   if (!myStringBuilderSegunda.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de fornos</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                           ...
                           <%  }  %>
                              ...
                              <%   if (!myStringBuilderTerceira.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Vídeos de Lava Louças</b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
