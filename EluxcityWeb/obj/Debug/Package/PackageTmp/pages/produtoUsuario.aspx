<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="produtoUsuario.aspx.cs" Inherits="EluxcityWeb.pages.produtoUsuario"  %>
<%
    ...
    <body>
     ...
     <ul>
          <li><a class="liMenu" href="<%=urlVolta%>"  ><img src="../includes/arvore/imagens/home.png" class="img-responsive" style="cursor: pointer;" /></a></li>
            ...
            <li><a class="activeMenu" href="produtoUsuario.aspx?idUser=<%=idUser%>&username=<%=user%>&tipoAcesso=<%=tipoAcesso%>&usuario=<%=user%>" >Produto</a></li>
      ...
      <ul>
           <li><a class="liMenu" href="<%=urlVolta%>"  ><img src="../includes/arvore/imagens/home.png" class="img-responsive" style="cursor: pointer;" /></a></li>
            ...
            <li><a class="activeMenu?idUser=<%=idUser%>&username=<%=user%>&tipoAcesso=<%=tipoAcesso%>&usuario=<%=user%>" href="produto.aspx">Produto</a></li>
      ...
      <table width="100%"><tr>
         ...
         <div id="listagem" style="width:900px;" >
          <div class="panel panel-primary">
              <div class="panel-heading">Listagem dos Produtos</div>
