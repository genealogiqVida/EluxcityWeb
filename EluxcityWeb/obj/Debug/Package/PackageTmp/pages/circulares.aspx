<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="circulares.aspx.cs" Inherits="EluxcityWeb.pages.circulares" %>
          ...
          <div class="row">
              <div class="col"> 
               <div class="card" style="min-width: 1202px !important;">
                      <div style="overflow-y: auto; max-height: 1100px;" class="card-body">
       ...
       <tr>
           ...
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=username%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button></td>
                  ...
                  <%} %>
                       ...
                       <%   if (listStringBuilderAno.Count <= 0)
                  { %>
             ...
             <%  } else { %>  
                          <% string anoCorrente = ""; 
                          for(var i = 0; i < listStringBuilderAno.Count; i++) {
                            if (anoCorrente.Equals(""))
                            {
                                anoCorrente = listStringBuilderAno[i].getAno(); %>
                                <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b>Circulares - <%= anoCorrente %></b></label>
                                 </div>
                                </div>
                          <%}
                            if (!anoCorrente.Equals(listStringBuilderAno[i].getAno()))
                            {
                                anoCorrente = listStringBuilderAno[i].getAno(); %>
                                <div class="row">
                                 <div class="col">
                          ...
                          <div class="row">
                                 <div class="col">
                                           <% HttpContext.Current.Response.Write(listStringBuilderAno[i].GetStringBuilder().ToString());
                                             HttpContext.Current.Response.Flush(); %>
                                </div>
                          </div>
                          <%if(i == listStringBuilderAno.Count - 1) { %>
