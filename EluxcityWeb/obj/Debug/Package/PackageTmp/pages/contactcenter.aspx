...
<html style="background-color:#e6e6e6">
    ...
    <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('https://server.impulse.net.br/arvoredecisao/pages/default.aspx?url=https://eluxcitysb-api.sabacloud.com&certificate=<%=certificate%>&userName=<%=username%>&idioma=pt-BR&urlVolta=https://www.eluxcity.com/home.aspx&tipoArvore=Arvore%20Backoffice&idUser=<%=idUser%>')"><label style="cursor: pointer"><b>Back Office N3</b></label></button>
</div>

                               <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('https://server.impulse.net.br/arvoredecisao/pages/default.aspx?url=https://eluxcitysb-api.sabacloud.com&certificate=<%=certificate%>&userName=<%=username%>&idioma=pt-BR&urlVolta=https://www.eluxcity.com/home.aspx&tipoArvore=Arvore%20Produtos&idUser=<%=idUser%>')"><label style="cursor: pointer"><b>Check List</b></label></button>
</div>

                               <div class="col-md align-self-center">    <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('https://server.impulse.net.br/arvoredecisao/pages/minhacoroa.aspx?url=https://eluxcitysb-api.sabacloud.com&certificate=<%=certificate%>&userName=<%=username%>&idioma=pt-BR&urlVolta=https://www.eluxcity.com/home.aspx&tipoArvore=Arvore%20Backoffice&idUser=<%=idUser%>')"><label style="cursor: pointer"><b>Coroas</b></label></button>
</div>
