...
namespace EluxcityWeb.pages
{
    public partial class videos : System.Web.UI.Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            List<ConteudoDTO> list = action.carregaVideoServico("Refrigerado", username);
            ...
            //carrega carrossel lançamentos
            list = action.carregaVideoServico("Ar condicionado", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {
            ...
            list = action.carregaVideoServico("Secadoras", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {

                myStringBuilderTreinamento.Append("<div class=\"item\"  style=\"cursor:pointer;\"  onclick=\"carregaConteudo('" + conteudoDTO.getId() + "')\" >");
                myStringBuilderTreinamento.Append(" <img  loading=\"auto\" class=\"item-image\" src=\"../includes/images/img_defaul.png\" />");
            ...
            list = action.carregaVideoServico("Fogões", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {


                myStringBuilderSugestao.Append("<div class=\"item\"  style=\"cursor:pointer;\"  onclick=\"carregaConteudo('" + conteudoDTO.getId() + "')\" >");
                myStringBuilderSugestao.Append(" <img  loading=\"auto\" class=\"item-image\" src=\"../includes/images/img_defaul.png\" />");
            ...
            //carrega carrossel sugestao
            list = action.carregaVideoServico("Máquina", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {
            ...
            //carrega carrossel sugestao
            list = action.carregaVideoServico("Condicionador", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {
            ...
            //carrega carrossel sugestao
            list = action.carregaVideoServico("Eletroportáteis", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {
            ...
            //carrega carrossel sugestao
            list = action.carregaVideoServico("Fornos", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {
            ...
            //carrega carrossel sugestao
            list = action.carregaVideoServico("Lava Louças", username);
            foreach (ConteudoDTO conteudoDTO in list)
            {
