...
<table style="width:70%">
       <tr>
           ...
           <td><button type="button" class="btn btn-warning" style=" background-color:#f7f0e9"><label ><b><%=btnVideos %></b></label></button></td> 
       </tr>
...
<%} %>
             ...
             <%  } else { %>
                          ...
                          <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b><%=tituloArCondicionado %></b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                          ...
                          <div class="row">
                             ...
                             <%  }  %>
                              ...
                              <%   if (!myStringBuilderRecente.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b><%=tituloMaquinasLavar %></b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                             ...
                             <%  }  %>
                              ...
                              <%   if (!myStringBuilderPopular.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b><%=tituloCondicionadoresAr %></b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                           ...
                           <%  }  %>
                              ...
                              <%   if (!myStringBuilderPrimeira.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b><%=tituloEletroportateis %></b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
                            ...
                            <%  }  %>
                              ...
                              <%   if (!myStringBuilderSegunda.ToString().Equals(""))        { %>
                                                    ...
                                                    <div class="row">
                                 <div class="col">
                                        <label class="lblCarrossel"><b><%=tituloFornos %></b></label>
                                 </div>
                          </div>
                          <div class="row">
                                 <div class="col">
