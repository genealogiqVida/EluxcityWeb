<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="braConsumerCare.aspx.cs" Inherits="EluxcityWeb.pages.braConsumerCare" %>
                      ...
                      <div class="card-body">
                          ...
                          <div class="container">
                              ...
                              <table style="width: 70%">
                                  <tr>
                                      <td><a target="_top" href="https://use.sabacloud.com/Saba/Web_spf/NA1PRD0102/app/shared;spf-url=common%2Fchanneldetail%2Fteams000000000004863">
                                          <button type="button" class="btn btn-warning" style="cursor: pointer">
                                              <label style="cursor: pointer"><b>Conheça a USE</b></label></button></a></td>
                                      ...
                                      <td>
                                          <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>&pais=<%=pais%>')">
                                              <label style="cursor: pointer"><b>Manual de serviços</b></label></button></td>
                                      <td>
                                          <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>&pais=<%=pais%>')">
                                              <label style="cursor: pointer"><b>Boletins técnicos</b></label></button></td>
                                      <td>
                                          <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>&pais=<%=pais%>')">
                                              <label style="cursor: pointer"><b>Vídeos</b></label></button></td>
                                      <td>
                                          <button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('circulares.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>&pais=<%=pais%>')">
                                              <label style="cursor: pointer"><b>Circulares</b></label></button></td>
                                  </tr>
                ...
                <div class="row" style="margin-top: 30px; width: 100%">
                    <div class="col-md-12">
                        <div class="row flex-container" style="flex-wrap: nowrap;">
                            <%if (dominio == "PER - Consumer Care" || dominio == "COL - Consumer Care" || dominio == "ECU - Consumer Care")
                                {%>
                            <div class="col-4">
