   ...
   <% if(equipe.ToString().Equals("S")) { %>    
                                  ...
                                  <table style="width:70%">
                                       <tr>
                                           ...
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Manual de serviços</b></label></button></td>
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button></td>
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button></td>
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('circulares.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Circulares</b></label></button></td>
                                       </tr>
...
<table style="width:52%">
       <tr>
           <!--<td><button type="button" class="btn btn-warning" style="cursor: pointer"><label style="cursor: pointer"><b>Service Plus</b></label></button></td>-->
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Manual de serviços</b></label></button></td>
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button></td>
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button></td>
                        ...
                        <div class="row flex-container" style="flex-wrap: nowrap;">
                            ...
                            <div class="col-8">
                                <ul class="list-unstyled"
                                    ...
                                    <%} else if (dominio != "BRA - Consumer Care")
                                        { %>
