           ...
           {%>    
                                  ...
                                  <table style="width:90%">
                                       <tr>
                                           ...
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('minhacoroa.aspx?url=https://use-api.sabacloud.com&certificate=<%=certificate %>&userName=<%=username%>&nomeCompleto=<%=nomeCompleto %>&equipe=<%=equipe %>&idUser=<%=idUser %>')"><label style="cursor: pointer"><b>Extrato de Coroas</b></label></button></td>
                                           ...
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>')"><label style="cursor: pointer"><b>Manual de serviços</b></label></button></td>
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button></td>
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button></td>
                                           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('circulares.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&dominio=<%=dominio%>&nomeCompleto=<%=nomeCompleto%>')"><label style="cursor: pointer"><b>Circulares</b></label></button></td>
                                       </tr>
...
<table style="width:80%">
       <tr>
           ...
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('manual.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&nomeCompleto=<%=nomeCompleto%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Manual de serviços</b></label></button></td>
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('boletim.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&nomeCompleto=<%=nomeCompleto%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Boletins técnicos</b></label></button></td>
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('videos.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&nomeCompleto=<%=nomeCompleto%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Vídeos</b></label></button></td>
           <td><button type="button" class="btn btn-warning" style="cursor: pointer" onclick="carregaTela('circulares.aspx?idUser=<%=idUser%>&username=<%=personNO%>&equipe=<%=equipe%>&certificate=<%=certificate%>&nomeCompleto=<%=nomeCompleto%>&dominio=<%=dominio%>')"><label style="cursor: pointer"><b>Circulares</b></label></button></td>
       </tr>
                ...
                <div class="row" style="margin-top: 30px; width: 100%">
                    <div class="col-md-12">
                        <div class="row flex-container" style="flex-wrap: nowrap;">
                            ...
                            <div class="col-8">
                                <ul class="list-unstyled"
                                    <%if (username == "00701708948" || username == "78248752615" || username == "86826050153" || username == "01365776794")
                                        { %>
                                        <li style="margin-bottom: 10px; font-size: 20px;"><a onclick="carregaTela('minhacoroa.aspx?url=https://use-api.sabacloud.com&certificate=<%=certificate %>&userName=<%=username%>&nomeCompleto=<%=nomeCompleto %>&equipe=<%=equipe %>&idUser=<%=idUser %>')" style="color: #FFF; text-decoration: solid; cursor: pointer">Extrato de Coroas</a></li>
                                    <%} else if (dominio != "BRA - Consumer Care" && dominio != "BRA - Service Center")
                                        { %>
                                    <li style="margin-bottom: 10px; font-size: 20px;"><a onclick="carregaTela('minhacoroa.aspx?url=https://use-api.sabacloud.com&certificate=<%=certificate %>&userName=<%=username%>&nomeCompleto=<%=nomeCompleto %>&equipe=<%=equipe %>&idUser=<%=idUser %>')" style="color: #FFF; text-decoration: solid; cursor: pointer">Extrato de Coroas</a></li>
                                    <%} %>
                                    <li style="margin-bottom: 10px; font-size: 20px;"><a target="_blank" href="https://institucional.electrolux.com.br/politica-de-privacidade-e-protecao-de-dados-pessoais?_ga=2.144648432.434692142.1655132852-1219181277.1645451090" style="color: #FFF; text-decoration: solid">Política de privacidade</a></li>
                                    <li style="margin-bottom: 10px; font-size: 20px;"><a href="" onclick="alert('Em breve - Página em construção');" style="color: #FFF; text-decoration: solid">Termos de uso</a></li>
                                    <li style="margin-bottom: 10px; font-size: 20px; cursor: pointer;"><a href="" onclick="alert('Em breve - Página em construção');" style="color: #FFF; text-decoration: solid">Ajuda</a></li>
                                </ul>
                            </div>
